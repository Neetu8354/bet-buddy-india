...
const Cricket = () => (
  <GamePageTemplate
    ...
    hreflang={[
      { lang: "en-IN", href: "https://yolo365.live/games/cricket-betting" },
      { lang: "x-default", href: "https://yolo365.live/games/cricket-betting" },
    ]}
    ...
    strategyTitle="Cricket betting strategy that actually works"
    strategy={
      <>
