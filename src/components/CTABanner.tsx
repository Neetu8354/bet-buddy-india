  ...
  <section className="container py-16">
    <div className="relative rounded-lg overflow-hidden border hairline bg-card/40 p-10 md:p-16 text-center">
      ...
      <div className="relative max-w-2xl mx-auto">
        ...
        <p className="text-sm md:text-base text-muted-foreground mb-8">Indian players trust YOLO365 for IPL 2026, live casino and fast payouts. You're one WhatsApp message away.</p>
        <a href="https://wa.link/reddyanna_" target="_blank" rel="noopener noreferrer" onClick={openWhatsApp} className="inline-flex items-center gap-2 px-6 h-12 rounded-md bg-gold text-primary-foreground font-semibold text-sm hover:opacity-90 transition-opacity btn-glow">
